...
$this->mailer->protocol = 'smtp';
$this->mailer->mailpath = '/usr/sbin/sendmail';                // enables SMTP debug information (for testing)
...
$this->mailer->smtp_timeout = '4';
$this->mailer->charset   = 'iso-8859-1';
$this->mailer->mailtype  = 'text';
