                            ...
                            <div class="ct-u-paddingTop20">
                                <div class="radio">
                                    ...
                                    <div class="ct-u-size15 ct-u-paddingLeft34 ct-u-paddingBoth20 text-justify">
                                        Silahkan Anda melakukan pembayaran sejumlah Rp. <?php $grand_total_idr=$grand_total+$total_ongkir; echo number_format($grand_total_idr,2,'.',',');  ?> kenomor rekening 1234567890 a/n Frop. Mr Mustika Natadikara
                                    </div>
                                </div>
                                <!--
                                <hr>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-3">
                        ...
                        <div class="ct-widgetLinks">
                            <ul class="ct-widgetLinks-list">
                                <li><a href="#">Memahami tentang kami</a></li>
                                <li><a href="#">Keamanan individu</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-3">
